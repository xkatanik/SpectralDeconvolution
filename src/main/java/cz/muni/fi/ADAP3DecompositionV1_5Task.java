...
public class ADAP3DecompositionV1_5Task extends AbstractTask {
     ...
     // Logger.
    private static final Logger LOG = Logger.getLogger(net.sf.mzmine.modules.peaklistmethods.peakpicking.adap3decompositionV1_5.ADAP3DecompositionV1_5Task.class.getName());
